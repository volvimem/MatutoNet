...
window.recuperarSenha = async function() {
    ...
    if (email) {
        ...
        sendPasswordResetEmail(auth, email)
            .then(() => { Swal.fire('Sucesso!', 'Um link de recuperação foi enviado para o seu e-mail. Verifique também a caixa de spam!', 'success'); })
            .catch((error) => { Swal.fire('Erro', 'Não foi possível enviar o e-mail. Verifique se digitou corretamente.', 'error'); });
    }
};
...
document.getElementById('formConfig').addEventListener('submit', function(e) { 
    ...
    set(refConfig, confData).then(() => { Swal.fire('OK!', 'Configurações salvas com sucesso!', 'success'); fecharModalConfig(); }); 
});
