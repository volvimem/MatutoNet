...
window.carregarMesesHistorico = function() { 
    ...
    mesesNomes.forEach((nM, i) => { 
        ...
        // Bloqueia meses antes do cadastro
        ...
        // Verifica se tá atrasado visualmente
        if (st !== 'pago') {
...
window.mudarStatusMes = function(m, st, nomeMes) { 
    // Regra simples: Se tiver pendente ou atrasado, aperta pra virar PAGO. Se tiver pago, volta pra pendente.
